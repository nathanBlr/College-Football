...
<body class="bg-[#334455]">
    <header>
        <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://ih1.redbubble.net/image.1895314886.6937/st,small,845x845-pad,1000x1000,f8f8f8.jpg" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">College Football</span>
            </a>
            ...
            <div class="hidden w-full" id="navbar-hamburger">
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded dark:bg-blue-600" aria-current="page">Conferences</a>
                </li>
                <li>
